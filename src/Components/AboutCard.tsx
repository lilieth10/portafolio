...
// import { Card, CardBody, Heading, Text, Box, List, ListItem, Icon } from '@chakra-ui/react';
// import { ImPointRight } from 'react-icons/im';

// const AboutCard: React.FC = () => {
//   return (
//     <Card border="1px solid #e0e0e0" boxShadow="md" p="6" rounded="md">
//       <CardBody>
//         <Box>
...
//           </Text>
//           <Text as="footer" textAlign="right">
//             - Lilieth
//           </Text>
//         </Box>
//       </CardBody>
